const CACHE_NAME = "fydar-lilypadleap-v0.1.0";
const MAIN_PAGE = "/play/lilypadleap";
const ASSETS = [
    MAIN_PAGE,
    "/play/lilypadleap/favicon.svg",
    "/play/lilypadleap/manifest.webmanifest",
    "/play/lilypadleap/build/lilypadleap.loader.js",
    "/play/lilypadleap/build/lilypadleap.framework.js.br",
];
    ...
    e.waitUntil(
        Promise.all([
            ...
            caches.keys().then((keys) => {
                return Promise.all(
                    keys.map((key) => {
                        if (key.startsWith("fydar-lilypadleap-") && key !== CACHE_NAME) {
