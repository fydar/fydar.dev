const CACHE_NAME = "fydar-thedwellers-v0.1.0";
const MAIN_PAGE = "/play/thedwellers";
const ASSETS = [
    MAIN_PAGE,
    "/play/thedwellers/favicon.svg",
    "/play/thedwellers/manifest.webmanifest",
    "/play/thedwellers/build/thedwellers.loader.js",
    "/play/thedwellers/build/thedwellers.framework.js.br",
];
    ...
    e.waitUntil(
        Promise.all([
            ...
            caches.keys().then((keys) => {
                return Promise.all(
                    keys.map((key) => {
                        if (key.startsWith("fydar-thedwellers-") && key !== CACHE_NAME) {
