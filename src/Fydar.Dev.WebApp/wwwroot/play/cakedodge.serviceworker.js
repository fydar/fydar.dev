const CACHE_NAME = "fydar-cakedodge-v1.0.0";
const MAIN_PAGE = "/play/cakedodge";
const ASSETS = [
    MAIN_PAGE,
    "/play/cakedodge/favicon.svg",
    "/play/cakedodge/manifest.webmanifest",
    "/play/cakedodge/build/cakedodge.loader.js",
    "/play/cakedodge/build/cakedodge.framework.js.br",
];
    ...
    e.waitUntil(
        Promise.all([
            ...
            caches.keys().then((keys) => {
                return Promise.all(
                    keys.map((key) => {
                        if (key.startsWith("fydar-cakedodge-") && key !== CACHE_NAME) {
