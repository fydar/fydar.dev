const CACHE_NAME = "fydar-thenewearthconflict-v0.1.0";
const MAIN_PAGE = "/play/thenewearthconflict";
const ASSETS = [
    MAIN_PAGE,
    "/play/thenewearthconflict/favicon.svg",
    "/play/thenewearthconflict/manifest.webmanifest",
    "/play/thenewearthconflict/build/thenewearthconflict.loader.js",
    "/play/thenewearthconflict/build/thenewearthconflict.framework.js.br",
];
    ...
    e.waitUntil(
        Promise.all([
            ...
            caches.keys().then((keys) => {
                return Promise.all(
                    keys.map((key) => {
                        if (key.startsWith("fydar-thenewearthconflict-") && key !== CACHE_NAME) {
