const CACHE_NAME = "fydar-airseabattle-v0.1.0";
const MAIN_PAGE = "/play/airseabattle";
const ASSETS = [
    MAIN_PAGE,
    "/play/airseabattle/favicon.svg",
    "/play/airseabattle/manifest.webmanifest",
    "/play/airseabattle/build/airseabattle.loader.js",
    "/play/airseabattle/build/airseabattle.framework.js.br",
];
    ...
    e.waitUntil(
        Promise.all([
            ...
            caches.keys().then((keys) => {
                return Promise.all(
                    keys.map((key) => {
                        if (key.startsWith("fydar-airseabattle-") && key !== CACHE_NAME) {
