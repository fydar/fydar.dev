const CACHE_NAME = "fydar-snoot-v0.0.4";
const MAIN_PAGE = "/play/snoot";
const ASSETS = [
    MAIN_PAGE,
    "/play/snoot/favicon.svg",
    "/play/snoot/manifest.webmanifest",
    "/play/snoot/build/snoot.loader.js",
    "/play/snoot/build/snoot.framework.js.br",
];
    ...
    e.waitUntil(
        Promise.all([
            ...
            caches.keys().then((keys) => {
                return Promise.all(
                    keys.map((key) => {
                        if (key.startsWith("fydar-snoot-") && key !== CACHE_NAME) {
